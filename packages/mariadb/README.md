...
Reusable MariaDB database package.
...
```powershell
dockyard package lint .\packages\mariadb --strict
dockyard package test .\packages\mariadb --strict
dockyard install mariadb .\packages\mariadb
```
