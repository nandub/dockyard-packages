...
Caddy web server package with optional public HTTP/HTTPS ports.
...
```powershell
dockyard package lint .\packages\caddy --strict
dockyard package test .\packages\caddy --strict
dockyard install caddy .\packages\caddy
```
