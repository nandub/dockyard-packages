...
RabbitMQ message broker package with management UI.
...
```powershell
dockyard package lint .\packages\rabbitmq --strict
dockyard package test .\packages\rabbitmq --strict
dockyard install rabbitmq .\packages\rabbitmq
```
