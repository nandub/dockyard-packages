...
```powershell
dockyard package lint .\packages\pgadmin --strict
dockyard package test .\packages\pgadmin --strict
dockyard install pgadmin .\packages\pgadmin
```
...
Expose this package only on trusted networks. pgAdmin is an administrative interface.
