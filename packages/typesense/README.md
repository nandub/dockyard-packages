...
Typesense search engine package.
...
```powershell
dockyard package lint .\packages\typesense --strict
dockyard package test .\packages\typesense --strict
dockyard install typesense .\packages\typesense
```
