...
Grafana Alloy collector starter package with no host mounts by default.
...
```powershell
dockyard package lint .\packages\alloy --strict
dockyard package test .\packages\alloy --strict
dockyard install alloy .\packages\alloy
```
...
This default package avoids host log mounts and Docker socket access. Add collection integrations explicitly for your environment.
