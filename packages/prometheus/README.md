...
Prometheus metrics database package with a minimal self-scrape config.
...
```powershell
dockyard package lint .\packages\prometheus --strict
dockyard package test .\packages\prometheus --strict
dockyard install prometheus .\packages\prometheus
```
