...
Adminer database administration UI package.
...
```powershell
dockyard package lint .\packages\adminer --strict
dockyard package test .\packages\adminer --strict
dockyard install adminer .\packages\adminer
```
...
Expose this package only on trusted networks. Adminer is an administrative interface.
