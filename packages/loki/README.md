...
Grafana Loki log store package using local filesystem storage.
...
```powershell
dockyard package lint .\packages\loki --strict
dockyard package test .\packages\loki --strict
dockyard install loki .\packages\loki
```
